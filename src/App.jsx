    ...
    return (
        ...
        >
                ...
                >
                    <form onSubmit={handleContinue} className="form">
                        ...
                        >
                            ...
                            <option value="Doctorate or Professional">
            ...
            {result === "approved" && (
                ...
                >
                    <h1 style={{ color: "#66ccff", fontSize: "2.5rem" }}>
                        🎉 Congratulations!
                    </h1>
                    <p
                        style={{
                    ...
                    >
                        You have been approved for a loan amount of $
                        {form.mortgageAmount}!
                    </p>
                    <button
                        type="button"
            ...
            {result === "rejected" && (
                ...
                >
                    <h1 style={{ color: "#FF6600", fontSize: "2.5rem" }}>
                        😞 Sorry!
                    </h1>
                    <p
                        style={{
...
function App() {
    ...
    const handleFormSubmit = (approvalPercentage) => {
        if (approvalPercentage !== undefined) {
            setApprovalPercent(approvalPercentage);
        }
        setPage("result");
    };
    ...
    return (
        <div className="app">
            ...
            {page === "bank" && (
                <VillageBankPage onBack={() => setPage("main")} />
            )}
        </div>
    );
}
